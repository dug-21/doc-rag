...
claude-flow memory store architecture/overview/design-principles "Your design principles here"

# Store architectural decisions
claude-flow memory store architecture/overview/architectural-decisions "Key decisions: 1) REST API design, 2) Component-based UI, 3) Service layer pattern"
```
...
```bash
claude-flow memory list --pattern "architecture/*"
```
